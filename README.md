...
broad phase par grille spatiale, rendu instancié = 1 draw call par mesh
partagé), mipmaps WebGPU.

Restent :

- Frottement bille-bille (le frottement n'agit qu'aux parois pour l'instant).
